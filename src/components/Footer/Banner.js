  ...
  return (
    <div className='min-h-[358px] footer_width footer_content rounded-[16px] bg-cloud flex justify-between gap-2 flex-wrap md:flex-nowrap'>
        <div className="px-[16px] md:pl-[50px] lg:pl-[106px] flex flex-col justify-center gap-1 max-w-[498px] py-6 lg:py-0">
            ...
            <button onClick={()=>{handleClick('/contactus?tab=tab1')}} className="bg-black mr-[8px] md:mr-[24px]  px-[12px] py-[10px] md:px-[16px] md:py-[14px] text-cloudText border-b-[3px] border-[#484D5E] rounded-[8px] text-[14px] font-semibold">
            Start working with us
            </button>
            <Link href='/contactus?tab=tab2' className="flex items-center gap-1 text-[16px] text-white hover:opacity-80">
