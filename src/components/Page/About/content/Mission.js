    ...
    <div className="navbar-main bg-white pt-[2rem] lg:pt-[14rem] pb-16 flex justify-between gap-4 flex-wrap lg:flex-nowrap">
      <div>
        ...
        <p className="text-[14px] text-[#080808] lg:max-w-[498px]">
          ...
          engineering, web app development, AI, Machine Learning, and Generative
          AI services, our mission is clear: to empower organizations to harness
          the transformative power of technology. We provide tailored solutions
          that not only address current needs but also prepare clients for
          future challenges. Through expertise, collaboration, and a commitment
          to excellence, we strive to help our clients thrive in an increasingly
          competitive and data-driven environment. Our mission is to be at the
          forefront of technological advancement and provide top-notch services
          that empower businesses to innovate, grow, and succeed. We exist to
          empower organizations with the tools and expertise they need to thrive
