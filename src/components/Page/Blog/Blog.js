                ...
                <Link href={`/blog/1`} className="">
                  <div className="md:max-w-[324px] casestudy_product_container">
                    <div
                      ...
                      style={{
                        backgroundImage: `url('/Image/casestudy/8.jpg')`,
                      }}
                    >
                    ...
                    <div className="my-4">
                      ...
                      <div className="casestudy_product_description mt-2 text-[14px] text-[#666666] leading-6">
                        Alternative data is like finding hidden treasures in
                        unexpected places and resources. They are information
                        collected from sources that are different from the usual
                        ones everyone uses and retrieves.This kind can give us
                        insights that regular sources might miss. can give us
                        insights that regular sources might miss. But what
                        counts as alternative data can change depending on the
