...
const CaseStudy = () => {
  return (
    <div className="main-container py-5 md:py-14">
      <div className="mb-8 w-full md:w-8/12 lg:w-4/12  md:text-left">
            ...
            return (
              <div key={index} className="md:w-80">
                ...
                <div className="flex gap-2 items-center text-xs mt-2 text-white">
                  ...
                  <div className="text-[10px] text-[#909090] tracking-wider">{item.published}</div>
                </div>

                <div className="my-4">
                  <div className="font-semibold text-[16px]">{item.title}</div>
                  <div className="mt-2 text-[14px] text-[#B8BEBF] leading-6">{item.description}</div>
                </div>
              </div>
            );
          })}
