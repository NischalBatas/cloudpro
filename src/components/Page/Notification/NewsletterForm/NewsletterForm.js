...
const NewsletterForm = () => {
  ...
  <div className="main-container4  md:bg-[black]  rounded-[16px] p-[24px] md:p-[55px]">
        ...
        <div className="md:max-w-[424px]">
         ...
         <span className="max-w-[366px] text-[24px] md:text-[32px] leading-8 md:leading-[42px] font-bold">Get Notify with our newsletter</span>
         </div>
           ...
           <span className="mt-2 text-[14px] text-[#b0b0b0]">Please scan the QR code to access the form.</span>
           </div>
</div>
