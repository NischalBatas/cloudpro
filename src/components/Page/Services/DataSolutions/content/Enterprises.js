...
import { enterprises } from "@/db/datasolutions/enterprises";
        ...
        >
          <div>
            <p className="font-medium text-[16px] max-w-[376px]">
              ...
              Tagline: Accelerate your data operations with Cloudproai’s robust
              and scalable data pipeline architectures.
            </p>
