...
export const introductionaiConsulting = {
  ...
  title: "AI Consulting",
  description:
    "Empower Your Business with Expert AI Consulting Services.\nIn today's competitive and rapidly evolving digital landscape, businesses of all sizes are on a quest for innovative solutions that can propel them ahead of the curve. At the heart of this quest is generative AI, a transformative force in artificial intelligence that offers unparalleled creativity and efficiency. Cloud ProAI stands as a beacon in this journey, enabling businesses to harness the power of generative AI apps to foster originality, automate processes, and personalize customer experiences at an unprecedented scale.",
...
export const introductiongenerativeAIApplications = {
  ...
  description:
    "Discover the power of Generative AI based applications in your industry. Equip your technology infrastructure with state-of-the-art LLM models to efficiently manage customer interaction, document flow, and process automation. Accelerate your business growth potential, adopt innovative solutions, and unlock new avenues of revenue growth with Cloudpro AI's Generative AI solutions.",
